<template>
  <div class="wrap">
    <div v-for="(item, key) in searchList" :key="key" class="wrap-item">
      ...
      <div v-if="item.type === 'timePicker'"> <!-- 时间-->
        {{ item.label }}:
      ...
      <div v-if="item.type === 'timePickerRange'"> <!--时间范围 -->
        {{ item.label }}:
        <el-time-picker
          v-model="item.value"
          is-range
      ...
      <div v-if="item.type === 'datePicker' || item.type === 'dateTimePicker'"> <!--日期 和 日期时间 -->
        {{ item.label }}:
        <el-date-picker
          v-model="item.value"
      ...
      <div v-if="item.type === 'datePickerRange' || item.type === 'dateTimePickerRange'"> <!--日期范围 和 日期时间范围 -->
        {{ item.label }}:
        <el-date-picker
          v-model="item.value"
